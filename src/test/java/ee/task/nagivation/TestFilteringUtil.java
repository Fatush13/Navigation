...
public class TestFilteringUtil extends Assertions {

   List<ReportedPosition> reports = new ArrayList<>();

   @Test
   void TestFilter() {
      addReport(2.05f, 2.75f, 1.98f, LocalDateTime.now().minus(Duration.of(6, SECONDS)));
      addReport(4.17f, 5.63f, 2.12f, LocalDateTime.now().minus(Duration.of(4, SECONDS)));
